...
public class buyBSEshares
{
  ...
  private WebElement buyselltoggle;
  ...
  public  buyBSEshares(WebDriver driver)
  {
	 this.driver=driver;
...
/*  public void verifyerrormsg()
  {
     ...
     // wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='message']")));
	  Actions act=new Actions(driver);
	 // String a=verifymsg.getText();
	 //String b="Markets are closed right now. Use GTT for placing long standing orders instead. Read more.";
